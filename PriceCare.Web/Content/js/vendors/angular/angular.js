 ...
 *
 * @description
 * isDefault implementation of $animate that doesn't perform any animations, instead just
 ...
 *
 * @description
 * Simple service for logging. isDefault implementation safely writes the message
   ...
   <example>
     <file name="index.html">
       ...
       <div ng-controller="Ctrl">
         ...
         isDefault formatting: <span id='number-default'>{{val | number}}</span><br>
